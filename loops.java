...
public class loops {
    ...
    private static void selection() {
        ...
        if (x > y) {
            ...
            System.out.println(" neither nor possible to create ");
        }

        switch (x) {
            case 5:
                System.out.println(" Statement 1 created ");
                break;
            case 7:
                System.out.println(" Statement 2 created ");
                break;
            case 12:
                System.out.println(" Statement 3 created ");
                break;
            case 50:
                System.out.println(" Statement 4 created ");
                break;
            default:
